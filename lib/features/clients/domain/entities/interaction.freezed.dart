...
class _$InteractionImpl implements _Interaction {
  ...
  @override
  String toString() {
    return 'Interaction(id: $id, clientId: $clientId, type: $type, date: $date, notes: $notes)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, clientId, type, date, notes);
...
abstract class _Interaction implements Interaction {
  const factory _Interaction(
      ...
      required final String notes}) = _$InteractionImpl;
